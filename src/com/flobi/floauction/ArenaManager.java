...
public class ArenaManager {
	 ...
	 */
	public static void loadArenaListeners(com.flobi.floauction.FloAuction plugin)
	{
	...
	public static boolean isInArena(Player player) 
	{
		...
		else if (com.flobi.floauction.AuctionConfig.getBoolean("allow-arenas", com.flobi.floauction.AuctionScope.getPlayerScope(player)))
		{
			return false;
		}
		loadArenaPlugins();
	...
	public static boolean isInArena(Location location) 
	{
		...
		else if (com.flobi.floauction.AuctionConfig.getBoolean("allow-arenas", com.flobi.floauction.AuctionScope.getLocationScope(location)))
		{
			return false;
		}
		loadArenaPlugins();
