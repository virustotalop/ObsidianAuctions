...
public enum Key {
    ...
    DEFAULT_BID_INCREMENT("default-bid-increment"),
    DEFAULT_STARTING_BID("default-starting-bid"),
    ...
    TIME_FORMAT_MINSEC("time-format-minsec"),
    TIME_FORMAT_SECONLY("time-format-seconly"),
